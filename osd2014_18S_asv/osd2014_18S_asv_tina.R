...
# load("osd2014_18S_asv/data/osd2014_18S_asv_pina_tina.Rdata", verbose = TRUE)
# load(url("http://osd2014.metagenomics.eu/osd2014_18S_asv/data/osd2014_18S_asv_pina_tina.Rdata"), verbose = TRUE)
...
load("osd2014_18S_asv/data/osd2014_18S_sparcc_filtered.Rda")
...
save(pina_tina_results, file = "osd2014_18S_asv/data/osd2014_18S_asv_pina_tina_results.Rdata")
save.image("osd2014_18S_asv/data/osd2014_18S_asv_pina_tina.Rdata")
# END: Save objects ------------------------------------------------------------
