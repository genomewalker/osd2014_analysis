...
osd2014_18S_otuXsample_physeq_filt_prev_beta_df <- as(otu_table(osd2014_dada2_phyloseq_beta), "matrix") %>% as.data.frame()
...
save.image("osd2014_18S_asv/data/osd2014_18S_niche_breadth.Rdata")
# END: Save objects ------------------------------------------------------------
