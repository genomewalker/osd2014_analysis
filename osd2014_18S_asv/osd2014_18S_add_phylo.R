...
osd2014_dada2_tree <- read.tree("osd2014_18S_asv/data/qiime2_placement/silva128/tree.nwk")

# If remote use
load(url("http://osd2014.metagenomics.eu/osd2014_18S_asv/data/osd2014_18S_asv_physeq_filt_objects.Rdata"), verbose = TRUE)
osd2014_dada2_tree <- read.tree(url("http://osd2014.metagenomics.eu/osd2014_18S_asv/data/qiime2_placement/ssilva128/tree.nwk"))
...
save.image("osd2014_18S_asv/data/osd2014_18S_asv_physeq_filt_objects_with_phylo.Rdata", )
# END: Save objects ------------------------------------------------------------


# BEGIN: QIMME2 fragment insertion ----------------------------------------
# qiime tools import --input-path osd2014_18S_asv/data/osd2014_18S_ASVs.fasta --type 'FeatureData[Sequence]' --output-path osd2014_18S_asv.qza
# qiime fragment-insertion sepp --i-representative-sequences osd2014_18S_asv.qza --o-tree osd2014_18S_insertion-tree.qza --o-placements osd2014_18S_insertion-placements.qza --i-reference-alignment ref/silva12.8.alignment.qza --i-reference-phylogeny ref/silva12.8.tree.qza --p-threads 32 --output-dir osd2014_18S --verbose
# qiime tools export osd2014_18S_insertion-tree.qza --output-dir osd2014_18S_exported-tree
