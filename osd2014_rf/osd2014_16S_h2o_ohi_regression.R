...
save_model_data(type = "16S", local_path = "osd2014_rf/data/h2o_models", remote_path = "/home/afernand/h2o_models")
# END: Save the models ----------------------------------------------------


# BEGIN: Reload the models ------------------------------------------------
# h2o.loadModel(path = "/home/afernand/h2o_models/16S/2018-11-28/rep_1/StackedEnsemble_model_R_1542698203489_190813")
#
# h2o.loadModel(path = "/home/afernand/h2o_models/16S/2018-11-28/rep_2/StackedEnsemble_model_R_1542698203489_190814")
#
# h2o.loadModel(path = "/home/afernand/h2o_models/16S/2018-11-28/rep_3/StackedEnsemble_model_R_1542698203489_190815")
#
# h2o.loadModel(path = "/home/afernand/h2o_models/16S/2018-11-28/rep_4/StackedEnsemble_model_R_1542698203489_190816")
#
# h2o.loadModel(path = "/home/afernand/h2o_models/16S/2018-11-28/rep_5/StackedEnsemble_model_R_1542698203489_190817")
#

h2o.loadModel(path = "/Users/ufo/Desktop/osd2014_analyses_repo/osd2014_analysis/osd2014_rf/data/h2o_models/16S/2018-12-14/rep_5/DeepLearning_grid_1_AutoML_20181213_153326_model_5")
h2o.loadModel(path = "/Users/ufo/Desktop/osd2014_analyses_repo/osd2014_analysis/osd2014_rf/data/h2o_models/16S/2018-12-14/rep_4/StackedEnsemble_AllModels_AutoML_20181213_145215")
h2o.loadModel(path = "/Users/ufo/Desktop/osd2014_analyses_repo/osd2014_analysis/osd2014_rf/data/h2o_models/16S/2018-12-14/rep_3/GBM_grid_1_AutoML_20181213_142127_model_2")
h2o.loadModel(path = "/Users/ufo/Desktop/osd2014_analyses_repo/osd2014_analysis/osd2014_rf/data/h2o_models/16S/2018-12-14/rep_2/DeepLearning_grid_1_AutoML_20181213_140041_model_3")
h2o.loadModel(path = "/Users/ufo/Desktop/osd2014_analyses_repo/osd2014_analysis/osd2014_rf/data/h2o_models/16S/2018-12-14/rep_1/DeepLearning_grid_1_AutoML_20181213_131919_model_3")
...
importance_h2o_filt <- importance_h2o %>% select(variable, rank) %>% group_by(variable) %>% summarise(N = n(), median_rank = median(rank)) %>% arrange(desc(N), median_rank)
...
pvd_low <- figure.pvd('LOW', NULL, plot.rug = T, plot.rank.lines = T, point.size = 1.5) +
  scale_x_log10() +
...
pvd_high <- figure.pvd('MEDIUM', NULL, plot.rug = T, plot.rank.lines = T, point.size = 1.5) +
  scale_x_log10() +
  scale_y_log10(limits = c(0.08, 15)) +
  xlab("Mean Distance to Tips") +
  ylab("Balance Variance") +
