...
osd2014_metadata <- tbl(my_db, "osd2014_cdata") %>%
  collect(n = Inf)
...
r1 <- raster("/Volumes/Extra/HALPERN/2013_scaled/tif/global_cumul_impact_2013_all_layers.tif")
r <- raster("/Volumes/Extra/HALPERN/2013_scaled/tif/global_cumul_impact_2013_all_layers.tif")
...
for(i in 1:length(files_rescaled_2013)) {
  ...
  f <- paste("/Volumes/Extra/HALPERN/2013_scaled/tif/", files_rescaled_2013[i], sep = "")
  r <- raster(f)
  ...
  for(k in 1: nrow(sc@coords)){
    ...
    out_rescaled_2013[k, m + 3] =  round(mean(e1, na.rm = TRUE),3)   ; colnames(out_rescaled_2013)[m + 3] = (paste(varName, "2013_50kms_mean", sep="_"))
    out_rescaled_2013[k, m + 4] =  round(min(e1, na.rm = TRUE),3)   ; colnames(out_rescaled_2013)[m + 4] = (paste(varName, "2013_50kms_min", sep="_"))
    out_rescaled_2013[k, m + 5] =  round(sd(e1, na.rm = TRUE),3) ; colnames(out_rescaled_2013)[m + 5] = (paste(varName, "2013_50kms_sd", sep="_"))
    out_rescaled_2013[k, m + 6] =  round(mad(e1, na.rm = TRUE, constant = 1),3) ; colnames(out_rescaled_2013)[m + 6] = (paste(varName, "2013_50kms_mad", sep="_"))
    ...
    out_rescaled_2013[k, m+7] =  round(max(e2, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+7] = (paste(varName, "2013_10kms_max", sep="_"))
    out_rescaled_2013[k, m+8] =  round(median(e2, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+8] = (paste(varName, "2013_10kms_median", sep="_"))
    out_rescaled_2013[k, m+9] =  round(mean(e2, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+9] = (paste(varName, "2013_10kms_mean", sep="_"))
    out_rescaled_2013[k, m+10] =  round(min(e2, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+10] = (paste(varName, "2013_10kms_min", sep="_"))
    out_rescaled_2013[k, m+11] =  round(sd(e2, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+11] = (paste(varName, "2013_10kms_sd", sep="_"))
    out_rescaled_2013[k, m+12] =  round(mad(e2, na.rm=TRUE, constant = 1),3) ; colnames(out_rescaled_2013)[m+12] = (paste(varName, "2013_10kms_mad", sep="_"))
    ...
    out_rescaled_2013[k, m+13] =  round(max(e3, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+13] = (paste(varName, "2013_5kms_max", sep="_"))
    out_rescaled_2013[k, m+14] =  round(median(e3, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+14] = (paste(varName, "2013_5kms_median", sep="_"))
    out_rescaled_2013[k, m+15] =  round(mean(e3, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+15] = (paste(varName, "2013_5kms_mean", sep="_"))
    out_rescaled_2013[k, m+16] =  round(min(e3, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+16] = (paste(varName, "2013_5kms_min", sep="_"))
    out_rescaled_2013[k, m+17] =  round(sd(e3, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+17] = (paste(varName, "2013_5kms_sd", sep="_"))
    out_rescaled_2013[k, m+18] =  round(mad(e3, na.rm=TRUE, constant = 1),3) ; colnames(out_rescaled_2013)[m+18] = (paste(varName, "2013_5kms_mad", sep="_"))
    ...
    out_rescaled_2013[k, m+19] =  round(max(e4, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+19] = (paste(varName, "2013_1kms_max", sep="_"))
    out_rescaled_2013[k, m+20] =  round(median(e4, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+20] = (paste(varName, "2013_1kms_median", sep="_"))
    out_rescaled_2013[k, m+21] =  round(mean(e4, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+21] = (paste(varName, "2013_1kms_mean", sep="_"))
    out_rescaled_2013[k, m+22] =  round(min(e4, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+22] = (paste(varName, "2013_1kms_min", sep="_"))
    out_rescaled_2013[k, m+23] =  round(sd(e4, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+23] = (paste(varName, "2013_1kms_sd", sep="_"))
    out_rescaled_2013[k, m+24] =  round(mad(e4, na.rm=TRUE, constant = 1),3) ; colnames(out_rescaled_2013)[m+24] = (paste(varName, "2013_1kms_mad", sep="_"))
    ...
    out_rescaled_2013[k, m+25] =  round(max(e0, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+25] = (paste(varName, "2013_100kms_max", sep="_"))
    out_rescaled_2013[k, m+26] =  round(median(e0, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+26] = (paste(varName, "2013_100kms_median", sep="_"))
    out_rescaled_2013[k, m+27] =  round(mean(e0, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+27] = (paste(varName, "2013_100kms_mean", sep="_"))
    out_rescaled_2013[k, m+28] =  round(min(e0, na.rm=TRUE),3)   ; colnames(out_rescaled_2013)[m+28] = (paste(varName, "2013_100kms_min", sep="_"))
    out_rescaled_2013[k, m+29] =  round(sd(e0, na.rm=TRUE),3) ; colnames(out_rescaled_2013)[m+29] = (paste(varName, "2013_100kms_sd", sep="_"))
    out_rescaled_2013[k, m+30] =  round(mad(e0, na.rm=TRUE, constant = 1),3) ; colnames(out_rescaled_2013)[m+30] = (paste(varName, "2013_100kms_mad", sep="_"))
...
out_rescaled_2013_median_long <- out_rescaled_2013 %>%
  dplyr::select(osd_id, contains("_median")) %>%
...
out_rescaled_2013_min_long <- out_rescaled_2013 %>%
  dplyr::select(osd_id, contains("min")) %>%
  dplyr::rename(label = osd_id) %>%
  gather(ohi_variable, min, -label) %>% tbl_df %>%
  mutate(ohi_variable = gsub("_2013_all_layers", "", ohi_variable)) %>%
  mutate(ohi_variable = gsub("_2013_minus_", "_diff_", ohi_variable)) %>%
  separate("ohi_variable", c("ohi_variable", "buffer"), sep = "_2013_", remove = TRUE) %>%
  mutate(buffer = gsub("s_min", "", buffer))

out_rescaled_2013_sd_long <- out_rescaled_2013 %>%
  dplyr::select(osd_id, contains("_sd")) %>%
  dplyr::rename(label = osd_id) %>%
  gather(ohi_variable, sd, -label) %>% tbl_df %>%
  mutate(ohi_variable = gsub("_2013_all_layers", "", ohi_variable)) %>%
  mutate(ohi_variable = gsub("_2013_minus_", "_diff_", ohi_variable)) %>%
  separate("ohi_variable", c("ohi_variable", "buffer"), sep = "_2013_", remove = TRUE) %>%
  mutate(buffer = gsub("s_sd", "", buffer))

out_rescaled_2013_mad_long <- out_rescaled_2013 %>%
  dplyr::select(osd_id, contains("_mad")) %>%
  dplyr::rename(label = osd_id) %>%
  gather(ohi_variable, mad, -label) %>% tbl_df %>%
  mutate(ohi_variable = gsub("_2013_all_layers", "", ohi_variable)) %>%
  mutate(ohi_variable = gsub("_2013_minus_", "_diff_", ohi_variable)) %>%
  separate("ohi_variable", c("ohi_variable", "buffer"), sep = "_2013_", remove = TRUE) %>%
  mutate(buffer = gsub("s_mad", "", buffer))
...
dbWriteTable(con, c("osd_analysis", "osd2014_halpern_scaled_mean"), value=out_rescaled_2013_mean_long,overwrite=TRUE,row.names=FALSE)
dbWriteTable(con, c("osd_analysis", "osd2014_halpern_scaled_max"), value=out_rescaled_2013_max_long,overwrite=TRUE,row.names=FALSE)
dbWriteTable(con, c("osd_analysis", "osd2014_halpern_scaled_min"), value=out_rescaled_2013_min_long,overwrite=TRUE,row.names=FALSE)
dbWriteTable(con, c("osd_analysis", "osd2014_halpern_scaled_sd"), value=out_rescaled_2013_sd_long,overwrite=TRUE,row.names=FALSE)
dbWriteTable(con, c("osd_analysis", "osd2014_halpern_scaled_mad"), value=out_rescaled_2013_mad_long,overwrite=TRUE,row.names=FALSE)


out_rescaled_2013_mean_long %>% filter(mean == 0, ohi_variable == "global_cumul_impact") %>% group_by(buffer) %>% count()
out_rescaled_2013_median_long %>% filter(median == 0, ohi_variable == "global_cumul_impact") %>% group_by(buffer) %>% count()
...
out_rescaled_2013_mean_long$buffer <- factor(out_rescaled_2013_mean_long$buffer, levels = unique(out_rescaled_2013_mean_long$buffer) %>% naturalsort())

for (i in 1:13){
  fname <- paste("~/Downloads/halpern_mean_", i, "_072019.pdf", sep = "")
  pdf(fname, width = 14, height = 3)

  p <- ggplot(out_rescaled_2013_mean_long %>% filter(ohi_variable == "global_cumul_impact"), aes(mean)) +
...
out_rescaled_2013_mean_long %>%
  ...
  facet_wrap(~ohi_variable, scales = "free_x") +
